                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" name="construction_type" required>
                                <option selected disabled>Select construction type</option>
                ...
                <div class="card-body p-4">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="upload-area" onclick="document.getElementById('completionCert').click()">
                            ...
                            <input type="file" name="completionCert" id="completionCert" class="d-none"
                    ...
                    <!-- As-Built Plans -->
                    <div class="mb-4">
                        <label class="form-label fw-medium">Certificate of Completion issued by the Building Official
                            *</label>
                        <div class="upload-area" onclick="document.getElementById('asBuiltPlans').click()">
                            ...
                            <input type="file" name="asBuiltPlans" id="asBuiltPlans" class="d-none"
                    ...
                    <div class="mb-4">
                        ...
                        <div class="upload-area" onclick="document.getElementById('electricalCert').click()">
                            ...
                            <input type="file" name="electricalCert" id="electricalCert" class="d-none"
                    ...
                    <div class="mb-4">
                        ...
                        <div class="upload-area" onclick="document.getElementById('plumbingCert').click()">
                            ...
                            <input type="file" name="plumbingCert" id="plumbingCert" class="d-none"
                    ...
                    <div class="mb-4">
                        ...
                        <div class="upload-area" onclick="document.getElementById('fireSafetyCert').click()">
                            ...
                            <input type="file" name="fireSafetyCert" id="fireSafetyCert" class="d-none"
                    ...
                    <div class="mb-4">
                        <label class="form-label fw-medium">Clearance from Fire Department and other relevant offices
                            *</label>
                        <div class="upload-area" onclick="document.getElementById('buildingPermitOrig').click()">
                            ...
                            <input type="file" name="buildingPermitOrig" id="buildingPermitOrig" class="d-none"
                                accept=".pdf,.jpg,.jpeg,.png"
                                onchange="handleFileUpload(this, 'buildingPermitOrigPreview')" required>
                        </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="upload-area" onclick="document.getElementById('approvedBuildingPermit').click()">
                            ...
                            <p class="mb-1 fw-medium">Click to upload Building Permit</p>
                            <small class="text-muted">Original copy of approved building permit</small>
                            <input type="file" name="approvedBuildingPermit" id="approvedBuildingPermit" class="d-none"
                                accept=".pdf,.jpg,.jpeg,.png"
                                onchange="handleFileUpload(this, 'approvedBuildingPermitPreview')" required>
                        </div>
